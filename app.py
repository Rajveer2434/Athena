...
with st.sidebar:
    ...
    <div style="padding: 0 0.5rem 1.5rem; border-bottom: 1px solid #21262D; margin-bottom: 1.25rem;">
        <div style="display:flex;align-items:center;gap:0.6rem;margin-bottom:0.3rem;">
            ...
            <span style="font-size:1.1rem;font-weight:700;color:#F0F6FC;letter-spacing:-0.02em;">
                Athena AI
            </span>
        </div>
            ...
            if st.button("🔊 Speak Response"):
                ...
                st.components.v1.html(
                    ...
                    var msg = new SpeechSynthesisUtterance(
                        {repr(st.session_state["last_answer"])}
                    );
...
# History chats
    ...
    <div class="page-header">
        <h1>Chat History</h1>
        <p>Previous conversations with Athena</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if chats:
        ...
        for user_msg, bot_msg, timestamp in chats:

            st.markdown(f"""
            <div class="note-item">
                <b>🧑 User:</b><br>{user_msg}
                <hr>
                <b>🤖 Athena:</b><br>{bot_msg}
                <br><br>
